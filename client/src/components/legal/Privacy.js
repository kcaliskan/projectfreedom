...
const Privacy = () => {
  return (
    <Fragment>
      ...
      <p>
        AlgoLevel ("us", "we", or "our") operates the http://www.algolevel.com
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for AlgoLevel is
      ...
      <p>
        ...
        in our Terms and Conditions, accessible from http://www.algolevel.com
      </p>
      ...
      <p>AlgoLevel uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        AlgoLevel will take all steps reasonably necessary to ensure that your
      ...
      <p>
        AlgoLevel may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of AlgoLevel</li>
        <li>
      ...
      <ul>
        <li>By email: kaan@kcaliskan.com</li>
      </ul>
    </Fragment>
  );
};
